...
export const metadata = {
  title: 'Sign Up - Fooocus AI',
  description: 'Sign Up for Fooocus AI to begin creating',
}
          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="full-name">Username <span
                      className="text-red-600">*</span></label>
                  <input id="full-name" type="text" className="form-input w-full text-gray-300" placeholder="Make a cool Username" required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
              ...
              <div className="text-sm text-gray-500 text-center">
                I agree to be contacted by Fooocus AI by email as per the Fooocus AI <Link href="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Privacy Policy</Link>.
              </div>
