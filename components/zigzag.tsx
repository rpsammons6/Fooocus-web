          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div
                  ...
                  data-aos="fade-up">
                <video autoPlay muted loop id="myVideo" className={`${styles.glow}`} disablePictureInPicture style={{
                  position: 'relative',
                  width: '540px',
                  height: '400px',
                  objectFit: 'cover',
                  ...
                  <source src="/videos/tut1.mp4" type="video/mp4"/>
                </video>
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6"
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl mb-2" style={{
                    ...
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent'
                  }}>More speed. Less spend</div>
                  <h3 className="h3 mb-3">We're the Cheapest.</h3>
                  <p className="text-xl text-gray-400 mb-4">Compared to our competitors, we offer the lowest prices for quality AI
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div
                ...
                <video autoPlay muted loop id="myVideo" className={`${styles.glow}`} disablePictureInPicture style={{
                  ...
                  <source src="/videos/tut2.mp4" type="video/mp4"/>
                </video>
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6"
