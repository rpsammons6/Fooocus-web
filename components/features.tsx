          ...
          <div className="py-12 md:py-20">
            ...
            <div
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up"
                ...
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG2.webp"
                     alt="IMG1"/>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="000"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG1.jpg" alt="IMG2"/>
              </div>

              {/* 3rd item */}
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="000"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG8.webp" alt="IMG3"/>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG13.webp"
                     alt="IMG5"/>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG11.png" alt="IMG6"/>
              </div>

              {/* 7th item */}
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG15.webp" alt="IMG7"/>
              </div>

              {/* 8th item */}
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG16.png" alt="IMG8"/>
              </div>

              {/* 9th item */}
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                   data-aos-anchor="[data-aos-id-blocks]">
                <img className={`${styles.hoverScale} ${styles.hoverGlow}`} src="/gallery/IMG14.webp" alt="IMG9"/>
              </div>
